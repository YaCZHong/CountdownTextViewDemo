package com.czh.countdowntextview
...
class CountdownTextView constructor(context: Context, attrs: AttributeSet) :
    ...
    init {
        ...
        text = resources.getText(R.string.cdtv_get_verification_code)
        isEnabled = true
    }
    ...
    fun startTask() {
        ...
        mCountDownTimer = object : CountDownTimer(mCountTime * 1000L + 100, mInterval * 1000L) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                post {
                    text =
                        "${resources.getText(R.string.cdtv_countdown)} ${(millisUntilFinished / 1000)}s"
                }
            }
        }
